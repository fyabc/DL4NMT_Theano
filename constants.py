...
Datasets = {
    ...
    'de-en':[
       'train.de-en.de', 'train.de-en.en',
        ...
        'test.de-en.de','test.de-en.en', 'test.de-en.en',
    ...
    'de-en_bpe_special_signal':[
       'train.de-en.special_signal.bpe.25000.de', 'train.de-en.special_signal.bpe.25000.en',
       'small_train.de-en.special_signal.bpe.25000.de', 'small_train.de-en.special_signal.bpe.25000.en',
       'dev.de-en.special_signal.bpe.25000.de', 'dev.de-en.special_signal.bpe.25000.en','dev.de-en.en',
       'test.de-en.special_signal.bpe.25000.de', 'test.de-en.special_signal.bpe.25000.en', 'test.de-en.en',
       'de-en_vocab.special_signal.bpe.25000.pkl', 'de-en_vocab.special_signal.bpe.25000.pkl',
    ],
    'en-de_small_bpe' :[
