...
python translate_single.py /datadrive/v-yanfa/model/complete/${model_name}.iter${6}.npz data/dic/vocab.bpe.32000.pkl data/dic/vocab.bpe.32000.pkl data/test/newstest2014.tok.bpe.32000.en ${output_file} -k 4
