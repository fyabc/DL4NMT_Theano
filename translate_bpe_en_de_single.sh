...
# Usage: translate_bpe_en_de_single.sh gpu_id n_enc n_dec residual_enc attention iteration [other]
...
python translate_single.py //gcr/Scratch/RR1/v-yanfa/SelectiveTrain/model/complete/${model_name}.iter${6}.npz data/dic/en-de_vocab.bpe.32000.pkl data/dic/en-de_vocab.bpe.32000.pkl data/test/test_en-de.en.tok.bpe.32000 ${output_file} -k 4
