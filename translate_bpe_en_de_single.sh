...
python translate_single.py /datadrive/v-yanfa/model/complete/${model_name}.iter${6}.npz data/dic/en-de_vocab.bpe.32000.pkl data/dic/en-de_vocab.bpe.32000.pkl data/test/test_en-de.en.tok.bpe.32000 ${output_file} -k 4
