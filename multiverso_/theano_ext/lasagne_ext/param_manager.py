...
class MVNetParamManager(object):
    ...
    def __init__(self, network):
        ...
        self.tbh = ArrayTableHandler(len(self.all_param_list), init_value=self.all_param_list)
        barrier()  # add barrier to make sure the initial values have token effect
